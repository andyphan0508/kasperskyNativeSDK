  ...
  return (
    <View style={{padding: 8}}>
      ...
      <View
        ...
        <Switch value={skipRiskwareAdWare} onChange={onEnableSkipRiskwareAdware} color="#00A88E" />
      </View>
      <View style={styles.view}>
        <View style={{flex: 1}}>
          <Text style={{fontSize: 15, fontWeight: 'bold', color: '#1D1D1B'}}>Quét UDS</Text>
          <Text style={{fontSize: 12, color: '#1D1D1B'}}>
            {'Cho phép bỏ qua tất cả những ứng dụng có mã độc trong máy của bạn'}
          </Text>
        </View>
...
const createStyles = () => {
  return StyleSheet.create({
    ...
    description: {color: '#1D1D1B', lineHeight: 20, fontSize: 15, marginVertical: 8},
